...
def main():
  ...
  url_sha1_hex1 = url_sha1(event1['queryStringParameters']['url'])
  print(url_sha1_hex1)

  print("qs: {}".format(event1['queryStringParameters']))
  event1['queryStringParameters']['url'] = unicode(url_sha1_hex)
  print("qs1: {}".format(event1['queryStringParameters']))
  #t_conv = ast.literal_eval(event1['queryStringParameters'])

  resmeta = get_item(table, event1['queryStringParameters'])
  print("get_item: {}".format(resmeta))
